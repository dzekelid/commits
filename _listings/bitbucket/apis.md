...
- name: Bitbucket Parameters Snippets Username Encoded  Commits Revision
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/commits/master/_listings/bitbucket/snippets-username-encoded-id-commits-revision-parameters.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/commits/master/_listings/bitbucket/snippets-username-encoded-id-commits-revision-parameters-postman.md
x-common:
- type: x-developer
