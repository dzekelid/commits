...
- name: Bitbucket
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/commits/master/_listings/bitbucket/repositories-username-repo-slug-commits-revision-parameters.md
x-common:
- type: x-developer
